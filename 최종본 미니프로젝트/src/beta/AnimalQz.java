...
public class AnimalQz {
	...
	// 게임 시작
	public void AnimalQ(TimerStart TS, String id) {
		MP3Player mp3 = new MP3Player();
		Controller con = new Controller();
		ArrayList<Music> mL = new ArrayList<>();
		String defaultPath = "C:\\Users\\SMHRD\\Desktop\\MP\\";
		...
		while (true) {
			 ...
			 if (point >= 0) {
				...
				while (true) {
					...
					ArrayList<ThemaDTO> list = gdao.animalQZ();
					String word1 = list.get(num).getAnimal();
					int mult = mul.mulCheck(word1);

					String word = list.get(num).getAnimal().toUpperCase();
...
//								System.exit(0);
	...
	public void AnimalQuiz( String id) {
