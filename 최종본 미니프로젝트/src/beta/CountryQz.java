...
public class CountryQz {
	...
	// 게임 시작
	public void CountryQ(TimerStart TS, String id) {
		...
		while (true) {
			 ...
			 if (point >= 0) {
				...
				while (true) {
					...
					ArrayList<ThemaDTO> list = gdao.countryQZ();
					String word1 = list.get(num).getCountry();
					int mult = mul.mulCheck(word1);

					String word = list.get(num).getCountry().toUpperCase();
...
//								System.exit(0);
	...
	public void CountryQuiz( String id) {
